...
/* define --------------------------------------------------------------------*/
#define CPU_DATA             "STM32F103"

#define MOS_VERSION          (1U)
#define MOS_SUBVERSION       (0U)
#define MOS_REVISION         (1U)

/* 进入临界区,irq */
#define mos_port_entry_critical_temp() \
    mos_port_interrupt_disable_temp()
/* 退出临界区,irq */
#define mos_port_exit_critical_temp(x) \
